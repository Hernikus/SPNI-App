...
public class DetailJogjaFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_detail_jogja, container, false);
    }
    ...
    public void onStart() {
        ...
        if (view != null) {
            ...
            Jogja jogja = Jogja.DAFTAR_JOGJA[(int) provinsiId];
            kabupatenKota.setText(jogja.getKabupatenKota());
            TextView deskripsi = (TextView) view.findViewById(R.id.textDescription2);
            deskripsi.setText(jogja.getDeskripsi());
        }
    }
